...
async def fix_template_columns():
    engine = create_async_engine(settings.DATABASE_URL, echo=False)
    try:
        async with engine.begin() as conn:
            print("Checking and adding missing columns to interview_templates...")
            fix_sql = """
            DO $$
            BEGIN
            ...
            print("✓ Successfully added missing columns to interview_templates!")
...
if __name__ == "__main__":
    asyncio.run(fix_template_columns())

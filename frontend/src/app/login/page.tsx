...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Store token (in a real app, use HttpOnly cookies or secure storage logic)
      ...
      <div className="w-full max-w-md bg-gray-800 border border-gray-700 rounded-2xl shadow-xl overflow-hidden">
        ...
        <div className="px-8 py-4 bg-gray-900/50 text-center border-t border-gray-700">
          <p className="text-sm text-gray-400">
            ...
            <Link href="/registration" className="font-semibold text-blue-400 hover:text-blue-300 underline decoration-blue-500/30 hover:decoration-blue-400 transition-all">
              Register here
            </Link>
          </p>
        </div>
